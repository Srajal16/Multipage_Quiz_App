        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (r2.getId( ) == selectedid ) {
                    ...
                    Toast toast = Toast.makeText(MainActivity4.this,"Correct Answer", Toast.LENGTH_SHORT);
                    toast.show();
                    ...
                    r3.setBackgroundColor(Color.parseColor("#ff8080"));
                    r4.setBackgroundColor(Color.parseColor("#ff8080"));
                    Toast toast = Toast.makeText(MainActivity4.this,"Wrong Answer", Toast.LENGTH_SHORT);
                    toast.show();
